...
See [`docs/framework.md`](../../docs/framework.md) for the framework architecture
and [`docs/new-game-template.md`](../../docs/new-game-template.md) for a
step-by-step guide to replacing this layer with a new game.
