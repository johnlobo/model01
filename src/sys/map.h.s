...
;; PUBLIC METHODS
;;===============================================================================
.globl sys_map_init    ;; HL=tileset, DE=initial map, IX=tile solidity table
.globl sys_map_set_collision_table ;; HL=tile solidity table
...
.globl current_map_data ;; 2-byte pointer to active tilemap data
